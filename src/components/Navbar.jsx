        ...
        <div className="container mx-auto">
            <div className="navbar bg-base-100">
                <div className="navbar-start">
                    ...
                    <Link to={HOME_ROUTE} className="btn btn-ghost text-xl text-center">CPD Monitor</Link>
                </div>
                ...
                {user ? (
                    <div className="navbar-end">
                        <button className="btn md:btn-wide bg-red-500" onClick={onLogout}>Logout</button>
                    </div>
                ) : (
                    <div className="navbar-end">
