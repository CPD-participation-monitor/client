    ...
    return (
        <>
            {success ? (
                ...
                <div className='register container-fluid col-12 m-0 p-0 position-relative' style={{backgroundImage: `url(${images.bg_jungle_landscape})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
